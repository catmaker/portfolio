      ...
      <div className="flex flex-col md:flex-row text-black w-4/5 m-auto min-h-20 items-center justify-center pt-32">
        ...
        <div className="flex w-5/6 mt-6 flex-col p-12">
          ...
          <div className="flex gap-2 items-center">
            ...
            <span className="text-custom-gray text-xs underline">
              010-4951-4437
            </span>
          </div>
          <div className="flex gap-2 items-center">
          ...
          <div className="flex gap-2 items-center">
            ...
            <span className="hover:text-custom-orange transition-colors duration-200 text-xs underline text-custom-gray">
